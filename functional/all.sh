...
python -c "import resttest; args=dict(); args['url']='$2'; args['test']='step1_metadata.yaml'; args['log']='$LOGGING_LEVEL'; args['interactive']=$INTERACTIVE; args['print_bodies']=$INTERACTIVE; resttest.main(args)" 2>&1
...
python -c "import resttest; args=dict(); args['url']='$2'; args['test']='step3_metadata_teardown.yaml'; args['log']='$LOGGING_LEVEL'; args['interactive']=$INTERACTIVE; args['print_bodies']=$INTERACTIVE; resttest.main(args)" 2>&1
